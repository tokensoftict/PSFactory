@extends('layouts.app')
@section('pageHeaderTitle1','Purchase Add')
@section('pageHeaderDescription','Add/Update Purchase')
...
@section('content')
    ...
    <livewire:purchase-order.purchase-order-form-component :purchaseorder="$purchaseorder"/>
@endsection
