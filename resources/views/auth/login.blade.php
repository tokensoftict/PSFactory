                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="{{ asset('') }}" class="d-block auth-logo">
                                    <img src="{{ asset('images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">{{ config('app.name', 'Peace Factory') }}</span>
                                </a>
                            </div>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">&copy; Factory Management System Designed Tokensoft ICT {{ date('Y') }} - 08130610626</p>
                            </div>
                        </div>
                    </div>
                </div>
