...
class CustomerReportController extends Controller
{
    ...
    public function balance_sheet(Request $request)
    {
        ...
        return setPageContent('reports.customer.balance_sheet', $data);
    ...
    public function customer_ledger(Request $request)
    {
        ...
        return setPageContent('reports.customer.customer_ledger', $data);
    }


    public function customer_incentive(Request $request)
    {
        $data = [
            'title' => 'Customer Incentive Report Report',
            'subtitle' => 'View Customer Incentive Report By Date Range and customer',
            'filters' => [
                'from' =>monthlyDateRange()[0],
                'to'=>monthlyDateRange()[1],
                'customer_id' => 1,
        ...
        return setPageContent('reports.customer.incentive_report', $data);
    }
